//Открытие файла с инвертированным индексом осуществляется через os.Args[1]
...
func main() {
	...
	if indstr != "" {
		fmt.Println("Введенные слова были найдены в текстах:" + indstr + "\n")
	} else {
		fmt.Println("Введенные слова не встречаются вместе")
	}
}
